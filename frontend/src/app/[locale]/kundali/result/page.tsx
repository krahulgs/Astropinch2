...
import { Download, Share2, Sparkles, Compass, Coins, Briefcase, Activity, Leaf, FileText, Lock, Flame, Shield, Stars } from 'lucide-react';
      ...
      <div id="pdf-content" className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="hidden print:flex items-center justify-between mb-8 border-b-2 border-secondary pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[8px] font-black uppercase tracking-[0.3em] text-secondary">NASA-Grade Precision</p>
            </div>
          </div>
          <div className="text-right">
            <p className="text-[10px] font-bold text-foreground">Premium Vedic Chart</p>
        ...
        <div className="hidden print:block pt-12 border-t border-border mt-20">
          <p className="text-[8px] text-text-secondary leading-relaxed italic text-center">
            Disclaimer: This Premium Vedic Chart is generated by AstroPinch AI for guidance and entertainment purposes only. 
            Astrology is a subjective science and results may vary. Decisions regarding life-altering events 
