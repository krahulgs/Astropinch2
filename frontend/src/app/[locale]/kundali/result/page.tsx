            ...
            <section className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                {[
                  ...
                  { label: t('result.analysis.mangal_dosha'),  value: calculations?.manglik?.is_parihara && calculations?.manglik?.is_manglik ? 'Neutralized' : (calculations?.manglik?.is_manglik ? t('result.analysis.manglik') : t('result.analysis.non_manglik')), color: (calculations?.manglik?.is_parihara && calculations?.manglik?.is_manglik) ? 'text-highlight' : (calculations?.manglik?.is_manglik ? 'text-alert' : 'text-highlight') },
